...
// * @author seth.sebeh
// */
//public class Starter1_28082019_uses_bridge {
//
//    final private String appHomeServer;
//    final private String appVersion;
//
//    public Starter1_28082019_uses_bridge() {
//        System.out.println("Starting A.M.A.R.D 1.0 ...");
//        //load set up data
//        List<Configuration> configs = loadSetUpData();
//        appHomeServer = Config.getKey(configs, "APP_HOME_SERVER");
//        appVersion = Config.getKey(configs, "VERSION");
...
//            List<Monitor> serviceEndpointAvailabilityMonitors = getServices("SEA");
//
...
//            Logger.getLogger(Starter1_28082019_uses_bridge.class.getName()).log(Level.SEVERE, null, ex);
//        }
//    }
//
//    public static void main(String[] args) {
//        new Starter1_28082019_uses_bridge().start();
//    }
//
...
//        List<Monitor> monitors = new AmardDAO().getMonitors();
...
//                ).collect(toList());
//
//        System.out.println("Done loading " + moniter_type + " monitors");
//
//        if (services.size() == 0) {
