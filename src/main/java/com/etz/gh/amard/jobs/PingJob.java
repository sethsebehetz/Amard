...
import com.etz.gh.amard.utilities.PingClient;
...
public class PingJob implements Job {
    ...
    final static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(PingJob.class);
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        try {
            ...
            String rsp = new PingClient().ping(monitor, monitor.getIp_address());
            ...
            if (err == 0) {
                ...
                message = "PING to ip " + monitor.getIp_address() + " FAILED.";
